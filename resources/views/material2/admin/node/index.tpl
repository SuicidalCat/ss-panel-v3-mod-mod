...
<div class="layui-container">
	...
	<!--title-->
	<div class="layui-row">
		<h1 class="site-h1">节点列表</h1>
		<div class="layui-layout-right sub">
			<a class="layui-btn" href="/admin/node/create"><i class="icon ptfont pticon-addnewbuttonpl"></i> 添加节点</a>
		</div>
	</div>
	...
	<div class="layui-row layui-col-space20">		
		...
		<div class="layui-col-md12">
			<div class="layui-card">
				<div class="layui-card-header">系统中所有节点的列表</div>
