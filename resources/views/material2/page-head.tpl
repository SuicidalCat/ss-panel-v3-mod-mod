  ...
  <div class="layui-side layui-side-menu" id="side-menu">
    <div class="layui-side-scroll">
      ...
      <div class="layui-logo logo">
        <a href="/user/"><img src="https://cdn.jsdelivr.net/gh/SuicidalCat/ss-panel-v3-mod-mod@v1.2.0.10/public/images/walllink_logo_black_small.png" height="35"></img>&nbsp;{$config["appName"]}</a>
      </div>
