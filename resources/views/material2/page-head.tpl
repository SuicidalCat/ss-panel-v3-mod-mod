...
<head>
  ...
  <link rel="icon" type="image/png" href="https://cdn.jsdelivr.net/gh/SuicidalCat/ss-panel-v3-mod-mod@v1.2.0.10/public/images/walllink_logo_whit_icon.ico"/>
  <!--[if lt IE 9]>
  ...
  <div class="layui-side layui-side-menu" id="side-menu">
    <div class="layui-side-scroll">
      ...
      <div class="layui-logo logo">
        <a href="/user/"><em><img src="https://cdn.jsdelivr.net/gh/SuicidalCat/ss-panel-v3-mod-mod@v1.2.0.10/public/images/walllink_logo_black_small.png" height="40"></em></a>
      </div>
