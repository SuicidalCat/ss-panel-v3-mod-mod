											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
														...
														<p><span class="icon icon-lg text-white">flash_auto</span> 普通接入點订阅（CN）：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$config['subUrl']}/link/{$ssr_sub_token}?mu=0" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="http://hxcq.applinzi.com/walllink/?link={$ssr_sub_token}?mu=0">點擊拷貝</button><br></p>
														...
														<p><span class="icon icon-lg text-white">flash_auto</span> 單端口接入點订阅（CN）：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$config['subUrl']}/link/{$ssr_sub_token}?mu=1" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="http://hxcq.applinzi.com/walllink/?link={$ssr_sub_token}?mu=1">點擊拷貝</button><br></p>
