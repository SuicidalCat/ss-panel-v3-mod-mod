...
<head>
	...
	<!-- css -->
	<link href="https://cdn.jsdelivr.net/gh/YihanH/ss-panel-v3-mod-mod@v1.2.0.1/public/theme/material/css/base.min.css" rel="stylesheet">
	<link href="https://cdn.jsdelivr.net/gh/YihanH/ss-panel-v3-mod-mod@v1.2.0.1/public/theme/material/css/project.min.css" rel="stylesheet">
		...
		<div class="menu-scroll">
			<div class="menu-content">
				...
				<ul class="nav">
                  ...
                  <li>
                    <div class="divcss5">
    					<img  src="https://cdn.jsdelivr.net/gh/YihanH/ss-panel-v3-mod-mod@v1.2.0.1/public/images/Ambassador-menu.png" width="230" height="300"/>
                      </div>
					</li>
					{/if}
				</ul>
